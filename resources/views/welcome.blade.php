                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <svg class="h-12 w-auto text-white lg:h-16 lg:text-[#FF2D20]" viewBox="0 0 62 65" fill="none" xmlns=""><path d= "Logo <fill="currentColor"/></svg>
                        </div>
                        @if (Route::has('login'))
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black">Match Details</h2>

                                            <p class="mt-4 text-sm/relaxed">
                                                Here you can see the match details of every Cricket Match
                                            </p>
                                        </div>
                                    </div>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Iconic Moments </h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        The special and memorable moments in the history of Cricket
                                    </p>
                                </div>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Cric Blogs</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Cric BLogs is a community driven portal where you can post you opinion about any macth or any players.
                                    </p>
                                </div>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Stadium Details</h2>
